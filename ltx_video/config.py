...
def load_train_config_from_yaml(yaml_path: str) -> TrainConfig:
    ...
    train_config = TrainConfig(
        ...
        learning_rate=float(train_block["learning_rate"]) if "learning_rate" in train_block else None,
        ...
        gradient_accumulation_steps=int(train_block.get("gradient_accumulation_steps", 1)),
        ...
        rf_shift=float(train_block.get("rf_shift")) if train_block.get("rf_shift") else None,
        rf_shifting=train_block.get("rf_shifting"),
        rf_base_resolution=int(train_block.get("rf_base_resolution", 32 * 32)),
        rf_target_shift_terminal=float(train_block.get("rf_target_shift_terminal")) if train_block.get("rf_target_shift_terminal") else None,
        rf_log_normal_mu=float(train_block.get("rf_log_normal_mu")) if train_block.get("rf_log_normal_mu") else None,
        rf_log_normal_sigma=float(train_block.get("rf_log_normal_sigma")) if train_block.get("rf_log_normal_sigma") else None,
