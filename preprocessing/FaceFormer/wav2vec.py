...
class Wav2Vec2Model(Wav2Vec2Model):
    ...
    def forward(
        ...
        proj_out = self.feature_projection(hidden_states)
        # Unwrap projection output if tuple
        hidden_states = proj_out[0] if isinstance(proj_out, (tuple, list)) else proj_out
